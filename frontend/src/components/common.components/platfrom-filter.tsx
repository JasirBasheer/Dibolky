...
export function PlatformFilter({ 
  ...
  // Get available platforms from connections (only valid ones)
  const availablePlatforms = connections?.connections
                      ...
                      connectedPages.map((page) => (
                        ...
                        >
                          <Checkbox
                            ...
                            onCheckedChange={() => handleConnectionToggle(page.id)}
                          />
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="font-medium text-sm max-w-[163px] truncate">{page.name}</div>
                            <div className="text-xs text-gray-500">Connected Page</div>
                          </div>
                        </div>
                      ))
                    )}
