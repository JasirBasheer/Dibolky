...
import { Cable, Camera, Check, ChevronDown, ChevronLeft, ChevronRight, CreditCard, Edit, ExternalLink, GitCommitHorizontal, Grid, MoreVertical, Save, Search, Settings, User, X, Zap } from 'lucide-react';
...
const SettingsPage = () => {
  ...
  const contacts = [
    {
      id: 1,
      name: 'Codewithjasir Connected Page',
      integration: 'Facebook Page',
      synced: true,
      lastSyncedSince: '18 minutes',
  ...
  function formatRelativeTime(dateString: string, addSuffix: boolean = true): string {
    try {
