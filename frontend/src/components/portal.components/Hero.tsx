      ...
      <div className='max-w-7xl mx-auto grid grid-cols-12 gap-4'>
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-lazare font-bold leading-tight text-black dark:bg-gradient-to-b dark:from-[#c3cacc] dark:to-[#dbe0e1] dark:text-transparent dark:bg-clip-text">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4 w-full sm:w-auto">
            <button className="dark:bg-[#202d42ea] bg-[#1c1e21ea]  text-white px-8 py-3 rounded-lg transition-colors duration-200 text-base sm:text-lg font-medium">
              Start 14-Day Free Trial
            </button>
            <button className="border border-[#202d42ea] dark:text-white light:text-[#2563EB] px-8 py-3 rounded-lg light:hover:bg-blue-50 transition-colors duration-200 text-base sm:text-lg font-medium">
              Watch Demo
            </button>
          </div>
        </div>
