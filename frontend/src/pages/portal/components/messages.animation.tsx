...
import { AnimatedBeam } from "@/components/magic.ui/animation.beam"; 
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 py-12 mt-18">
    <div className="flex w-full flex-col md:flex-row items-center gap-8">
      <div 
        className="w-full md:w-1/2 lg:w-3/5 px-6 space-y-6"
        ref={animationContentRef}
      >
        <h2 
          className={`text-3xl font-bold tracking-tight font-lazare text-foreground/90 ${getAnimationClass(0)}`}
          style={getAnimationStyle(0)}
        >
          Manage Your Messages & Leads Across All Platforms
        </h2>
        ...
        >
          Connect with your audience wherever they are, without switching between apps.
        </p>
        ...
        <div
          className={cn(
            "relative flex h-[300px] w-full md:w-1/2 lg:w-2/5 items-center justify-center overflow-hidden p-4",
