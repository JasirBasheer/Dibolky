...
export const ProtectedRoute = ({ children, role }: { children: ReactNode, role: string }) => {
      ...
      if (response.data) {
        if (role == "agency") {
          ...
          dispatch(setUser({
            ...
            facebookAccessToken: res.data.details?.social_credentials?.facebook?.accessToken || "",
            instagramAccessToken: res.data.details?.social_credentials?.instagram?.accessToken || "",
