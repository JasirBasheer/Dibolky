...
import InitialSetUp from '@/components/common.components/initial-set-up'
...
const AgencyDashboard: React.FC = () => {
  ...
  useEffect(() => {
    if (initialSetUp) {
      ...
      if (!isSkiped) {
        setIsInitailSetUpOpen(Object.values(initialSetUp).includes(false))
      }
    }
  }, [initialSetUp]);
