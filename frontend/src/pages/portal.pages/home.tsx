...
import Plans from '../../components/portal/Plans'
import { AnimatedBeamMultipleOutput } from '@/components/portal/dibolky.animation'
import { AnimatedBeamDemo } from '@/components/portal/messages.animation'
import TestimonialsSection from '@/components/portal/feedback'
import { GridPattern } from '@/components/magic.ui/box.pattern'
import { FeaturesCard } from '@/components/portal/bento.grid'
