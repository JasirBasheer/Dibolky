...
const Inbox = () => {
  ...
  return (
    <div className="sm:flex h-screen w-full mx-auto border-r border-t border-l-gray-300 bg-white">
      <div className="sm:w-[34em] w-full p-5 h-[41rem] border-r  border-l-gray-300">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuCheckboxItem
              ...
              onSelect={(e) => {
                e.preventDefault();
                setSelectedTab('withAttachments');
              }}
            >
              With attachments
            </DropdownMenuCheckboxItem>
            <DropdownMenuCheckboxItem
              // checked={filterOptions.lastWeek}
              onSelect={(e) => {
                e.preventDefault();
                setSelectedTab('withAttachments');
              }}
